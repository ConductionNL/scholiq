# Scholiq — Nextcloud Scholiq

## Overview

Scholiq is the official starter template for Conduction Nextcloud apps. It provides the standard structure, configuration, and tooling that all Conduction apps share.
...
- **Pattern**: Thin client — Scholiq provides UI/UX, OpenRegister handles persistence
- **License**: EUPL-1.2
...
| `lib/Settings/scholiq_register.json` | OpenAPI 3.0 register schema definition |
