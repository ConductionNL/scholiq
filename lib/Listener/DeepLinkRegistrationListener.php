...
/**
 * Scholiq DeepLinkRegistrationListener
 *
 * Registers Scholiq's deep link URL patterns with OpenRegister's search provider.
 *
 * @category Listener
 ...
 * Registers Scholiq's deep link URL patterns with OpenRegister's search provider.
 *
 * When a user searches in Nextcloud's unified search, results for Scholiq schemas
...
class DeepLinkRegistrationListener implements IEventListener
{
    ...
    public function handle(Event $event): void
    {
        ...
        // Replace 'scholiq' with your app ID and update the register slug,
        // schema slug, and URL template to match your app's actual schemas.
        $event->register(
            appId: 'scholiq',
            registerSlug: 'scholiq',
            schemaSlug: 'example',
            urlTemplate: '/apps/scholiq/#/examples/{uuid}'
        );
