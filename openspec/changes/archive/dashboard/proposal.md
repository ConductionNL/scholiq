...
- **mydash delegation**: heavy analytics (cross-tenant trends, advanced cohort comparisons) are NOT implemented in Scholiq. The Compliance Officer dashboard MUST include a "View in MyDash" deep link button for heavier analytics, satisfying REQ-DA-006.
